const linkedin = "https://www.linkedin.com/in/tanishq-j-913152288/";
const github = "https://github.com/TJ-2004";
const email = "mailto:tanishqjais9756@gmail.com";
var today = new Date();

about = [
  "<br>",
  "Hey, I'm Tanishq Jaiswal! 👋",
  "<br>",
  "I'm a student at SRM University, Kattankulathur,.",
  "I am currently pursuing B-TECH in CSE Department with specialization of Blockchain Technology.",
...
banner = [
  ...
  '<span class="index">Tanishq Jaiswal </span>',
  "<br>",
  "  ████████  █████  ███    ██ ██ ███████ ██   ██  ██████  ",
  "     ██    ██   ██ ████   ██ ██ ██      ██   ██ ██    ██ ",
  "     ██    ███████ ██ ██  ██ ██ ███████ ███████ ██    ██ ",
...
social = [
  ...
  'Linkedin       <a href="' +
    linkedin +
    '" target="_blank">linkedin/tanishq-j-913152288' +
    "</a>",
  'Github         <a href="' +
    github +
    '" target="_blank">github/TJ-2004' +
    "</a>",
  "<br>",
];
...
projects = [
  ...
  "<br>",
  "<br>",
  '<span class="command">4. Portfolio Website (This Website)</span>',
  "<br>",
];
